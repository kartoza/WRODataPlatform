...
test('test elements on landing page', async ({ page }) => {
  ...
  await expect(page.locator('#title-header')).toContainText('Welcome to the wro Portal');
  ...
  await expect(page.getByText('Welcome to the wro Portal METADATA Discover a world of data-driven')).toBeVisible();
