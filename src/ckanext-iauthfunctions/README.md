[![Tests](https://github.com/kartoza/ckanext-iauthfunctions/workflows/Tests/badge.svg?branch=main)](https://github.com/kartoza/ckanext-iauthfunctions/actions)
...
2. Clone the source and install it on the virtualenv
    ...
    git clone https://github.com/kartoza/ckanext-iauthfunctions.git
...
If ckanext-iauthfunctions should be available on PyPI you can follow these steps to publish a new version:
